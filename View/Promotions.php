...
<body class="bg-body">
	...
	<div class="container" style="border-style: solid;">
			...
			<div class ="col-sm-6" style="text-align:justify; float:right;">
				...
				<p>Dengan menambahkan kode voucher MK001 bisa mendapatkan discount 20% untuk pembelian Bebek Panggang di FuLay Restaurant</p>
				<p>Syarat & Ketentuan : 
		...
		<div class="container" style="border-style: solid;">
			...
			<div class ="col-sm-6" style="text-align:justify;">
				...
				<p>Hanya dengan membeli menu Babi Panggang di FuLay Restaurant, langsung bisa bawa pulang Hakau secara gratis dengan menggunakan kode voucher MK002</p>
				<p>Syarat & Ketentuan : 
